...
✨ I am **Jyotirmoy Paul** from the AI & DS department  
💡 Passionate about building **real-world impactful projects**  
🚀 Mission: *Inventing impossible solutions using AI*  

🏆 Participations:
- Solution Challenge 2026 – Build With AI (Google Developer Groups)
- Hack A Bit 2.0 – GDG
- Gemini Live Agent Challenge  

🧠 Built:
- **AI Personal Productivity Manager**
  - Tech: Gemini 2.0 Flash, FastAPI, React, Google Cloud Run  
...
## 🛠️ Core Tools (System Design)

<p>
  <img src="https://skillicons.dev/icons?i=vscode,git,github,googlecloud"/>
</p>
